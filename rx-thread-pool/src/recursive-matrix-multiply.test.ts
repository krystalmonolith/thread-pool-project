...
function printPreface(name: string, size: number, maxDepth: number, blockSize: number) {
    console.log(`\n${'='.repeat(60)}`);
...
function createExpected(name: string, size: number, maxDepth: number, blockSize: number, matrixA: Matrix, matrixB: Matrix): ExpectedResultTime {
